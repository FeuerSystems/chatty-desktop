  ...
  <div class="avatar-crop-modal">
    <div class="avatar-crop-wrapper">
      <div class="overlay center">
        <div class="modal" >
          <div class="modal-ctx">
            <span class="file-size">{{ readableFileSize(img.length) }}</span>
            <BaseButton
              text="Effects"
              :icon="require('@/assets/svg/icons/filter.svg')"
              type="primary"
              disabled
            />
            <div class="tools-wrap center">
              <div class="tools-container" v-if="img">
                <div class="section">
                  <span class="topic">
                    <b>Rotation</b>
                  </span>
                ...
                <div class="sub-tools-container fc">
...
export default {
  ...
  methods: {
    ...
    defaultSize({ imageSize, visibleArea }) {
      return {
        width: (visibleArea || imageSize).width / 1.5,
        height: (visibleArea || imageSize).height / 1.5,
      };
    },
    saveIcon(event) {
